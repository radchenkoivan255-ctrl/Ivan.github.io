...
const agents = [
    ...
    },
    {
        ...
        skills: {
            "Основна атака": "Basic Attack: Debt Reconciliation<br>Press Icon_Normal to activate:<br>Unleashes up to 3 strikes, dealing <span class='element-physical'>Physical DMG</span>.",
    ...
    },
    {
        ...
        skills: {
            "Основна атака": "Basic Attack: Load Up and Roll Out<br>Press Icon_Normal to activate:<br>Unleashes up to 4 slashes, dealing <span class='element-physical'>Physical DMG</span>.",

            "Ухилення + Атака": "Dodge: Handbrake Drift<br>Press Icon_Evade to activate:<br>A quick dash dodge.<br>Character is invulnerable while using this skill.<br><br>Dash Attack: Pedal to the Metal<br>Press Icon_Normal during a dodge to activate:<br>Slashes enemies in front, dealing <span class='element-physical'>Physical DMG</span>.<br><br>Dodge Counter: Power Drift<br>Press Icon_Normal during a Perfect Dodge to activate:<br>Unleash a downward smash attack in front, dealing <span class='element-physical'>Physical DMG</span>.<br>Character is invulnerable while using this skill.",
    ...
    },
    {
        ...
        skills: {
            "Основна атака": "Basic Attack: Lightning Strike<br>Press Icon_Normal to activate:<br>Unleashes up to 4 attacks in front, dealing <span class='element-physical'>Physical DMG</span> and <span class='element-electric'>Electric DMG</span>.<br><br>Basic Attack: Lightning Strike - Electrified<br>When <span class='highlight-white'>Resolve</span> is above or equal to 75%, hold Icon_Normal to activate.<br>Consume 75% <span class='highlight-white'>Resolve</span> to launch consecutive attacks in front, followed by a Finishing Move, dealing <span class='element-electric'>Electric DMG</span>.<br>When the Finishing Move hits an enemy, it triggers the <span class='highlight-white'>Quick Assist</span> of the squad member positioned before Seth.<br>Anti-Interrupt level is increased while using this skill.",
    ...
    },
    {
        ...
        skills: {
            "Основна атака": "Basic Attack: Full Firepower<br>Press Icon_Normal to activate: <br>Unleashes a piercing attack, dealing <span class='element-physical'>Physical DMG</span>.<br>Repeatedly press or hold to enter Crouching Shot to extend the attack duration.<br>Drag the joystick during Crouching Shot to launch Rolling Shot and adjust the character's position, dealing <span class='element-physical'>Physical DMG</span>.<br>Stop pressing or holding during Crouching Shot to launch Finishing Shot at enemies in front, dealing <span class='element-physical'>Physical DMG</span>.",
            ...
            "Спеціальна атака": "Special Attack: Stand Still<br>Press Icon_Special to activate:<br> Performs up to 3 piercing attacks in a line, dealing <span class='element-physical'>Physical DMG</span>.<br>Anti - Interrupt level is increased while using this skill.<br><br>EX Special Attack: Clearance Time<br>With enough Energy, press Icon_SpecialReady to activate:<br>Launches a powerful piercing attack in a line, dealing massive <span class='element-physical'>Physical DMG</span>.<br>Character is invulnerable while using this skill.",
    ...
    },
    {
        ...
        skills: {
            "Основна атака": "Basic Attack: Wipeout<br>Press Icon_Normal to activate:<br>Unleashes up to 5 slashes, dealing <span class='element-physical'>Physical DMG</span>.<br>Repeatedly press or hold the button during the 3rd and 5th hits to extend the chainsaw slash attack.",

            "Ухилення + Атака": "Dodge: Shoo!<br>Press Icon_Evade to activate:<br>A quick dash dodge.<br>Character is invulnerable while using this skill.<br><br>Dash Attack: Oopsy-Daisy!<br>Press Icon_Normal during a dodge to activate:<br>Slashes enemies in front, dealing <span class='element-physical'>Physical DMG</span>.<br>Repeatedly press or hold the button to extend the chainsaw attack's duration.<br><br>Dodge Counter: Nope!<br>Press Icon_Normal during a Perfect Dodge to activate:<br>Slashes enemies in front before detonating her chainsaw, dealing <span class='element-physical'>Physical DMG</span>.<br>Repeatedly press or hold the button to extend the chainsaw slash attack.<br>Character is invulnerable while using this skill.",
    ...
    },
    {
        ...
        skills: {
            "Основна атака": "Basic Attack: Cunning Combo<br>Press Icon_Normal to activate:<br>Unleashes up to 3 strikes, dealing <span class='element-physical'>Physical DMG</span>.<br><br>Basic Attack: Do As I Please<br>After using a Special Attack, EX Special Attack, Chain Attack, or Ultimate, Nicole can reload, and her Basic Attack and Dash Attack are enhanced, increasing the power of her bullets.",
    ...
    },
    {
        ...
        skills: {
            "Основна атака": "Basic Attack: Making Rice Cakes<br>Press Icon_Normal to activate:<br>Unleashes up to 3 attacks, dealing <span class='element-physical'>Physical DMG</span>.<br><br>Basic Attack: Making Rice Cakes (Frosted Banner)<br>When Frosted Banner is active, press Icon_Normal to activate:<br>Unleashes up to 3 faster attacks in front, dealing <span class='element-ice'>Ice DMG</span>.",

            "Ухилення + Атака": "Dodge: Grab a Bite<br>Press Icon_Evade to activate:<br>A quick dash dodge.<br>Character is invulnerable while using this skill.<br><br>Dash Attack: 50/50<br>Press Icon_Normal during a dodge to activate:<br>Slashes enemies in front, dealing <span class='element-physical'>Physical DMG</span>.<br><br>Dash Attack: 50/50 (Frosted Banner)<br>When Frosted Banner is active, press Icon_Normal during a Dodge to activate:<br>Slashes enemies in front, dealing <span class='element-ice'>Ice DMG</span>.<br><br>Dodge Counter: Away From My Snacks<br>Press Icon_Normal during a Perfect Dodge to activate:<br>Slashes enemies in front, dealing <span class='element-ice'>Ice DMG</span>.<br>Character is invulnerable while using this skill.",
    ...
    },
    {
        ...
        skills: {
            "Основна атака": "Basic Attack: Rampaging Slash<br>Press Icon_Normal to activate:<br> Unleashes up to 6 slashes ahead, dealing <span class='element-physical'>Physical DMG</span>.<br><br> Basic Attack: Dead End<br>When there are sufficient Assist Points, hold Icon_Normal to activate:<br>Consume 1 Assist Point to toss the shield and attack nearby enemies in all directions, dealing <span class='element-physical'>Physical DMG</span>.<br>Character is invulnerable while using this skill.",
            "Ухилення + Атака": "Dodge: Adrift<br>Press Icon_Evade to activate: <br>A quick dash dodge.<br>Character is invulnerable while using this skill.<br><br>Dash Attack: Hog Rush<br>Press Icon_Normal during a dodge to activate:<br> Strikes forward with the shield, dealing <span class='element-physical'>Physical DMG</span>.<br> During skill activation, DMG taken is reduced by 40%, and when attacked by an enemy, Caesar blocks with the shield and gets knocked back.Following that, press Icon_Special or Icon_SpecialReady to trigger Retaliation and activate Special Attack: Roaring Thrust or EX Special Attack: Overpowered Shield Bash.<br><br>Dodge Counter: Eye For an Eye<br>Press Icon_Normal during a Perfect Dodge to activate:<br>Stabs at enemies in front, dealing <span class='element-physical'>Physical DMG</span>.<br>Character is invulnerable while using this skill.",
